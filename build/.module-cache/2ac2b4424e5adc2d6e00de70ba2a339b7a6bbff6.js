    ...
    render: function () {
        ...
        return (
            React.DOM.div( {className:"commentForm"}, 
                ...
                errorsComponent,
                React.DOM.form( {className:"commentFormForm", onSubmit:this.handleSubmit}, 
					...
					React.DOM.div( {className:"row"}, 
						React.DOM.div( {className:"large-12 columns"}, 
							React.DOM.a( {href:"#", className:"button", ref:"submit", onClick:this.handleSubmit, value:this.props.submitText})
						)
					)
                )
            )
